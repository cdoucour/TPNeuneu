...
public class Cannibales extends Neuneu{
	...
	public Cannibales (int energie, String nourriture, String boisson, int position, int id_joueur){
		super(energie, nourriture, boisson, position, id_joueur);
	}
	
	// MANQUE :
	// Manger un autre neuneu
	// type d'aliment a pouvoir manger
